            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/steps') ? ' active' : '' }}"
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/account-sizes') ? ' active' : '' }}"
                                href="{{ route('admin.account-sizes.index') }}">
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Account Sizes</span>
                            </a>
                        </li>


                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/asset-types') ? ' active' : '' }}"
                                href="{{ route('admin.asset-types.index') }}">
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Asset Types</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/commission-structure*') ? ' active' : '' }}"
                                href="{{ route('admin.commission-structure.index') }}">
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Commission Structures</span>
                            </a>
                        </li>

                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/firms/requests*') ? ' active' : '' }}"
                                href="{{ route('admin.firms.requests') }}">
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Firms Requests</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/offers') ? ' active' : '' }}"
