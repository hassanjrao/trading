        ...
        <div class="col-md-8">
            ...
            <div class="search-container_2">
                ...
                <div class="search-results">
                    <div class="no-results"><span class="result-text">No results found for "MyFunded" </span><button
                            class="add-firm-btn">+ Add Firm</button></div>
                    <div class="result">
        ...
        <div class="col-md-8">
            ...
            <div class="search-resultsaf">
                <div class="search-resultsaf-con">
                    ...
                    <div class="button-1"><button type="button" class="btn-style">Request Submitted</button></div>
                </div>
            </div>
        </div>
        <div class="col-md-1"></div>
